...
function preload() {
  BallTouchesPaddle_SoundEffect = loadSound("ball_touch_paddel.wav");
  BallMissesPaddle_SoundEffect = loadSound("missed.wav");
}
...
function move(){
  ...
  if (ball.y >= paddle1Y&& ball.y <= paddle1Y + paddle1Height) {
    ball.dx = -ball.dx+0.5; 
    BallTouchesPaddle_SoundEffect.play()
  }
  else{
    pcscore++;
    reset();
    navigator.vibrate(100);
    BallMissesPaddle_SoundEffect.play()
  }
}
if(pcscore ==4){
    fill("#FFA500");
